    ...
    if (typeof plugin !== "string") {
        ...
        config = {
            ...
            develop: {
                ...
                host: (_k = (_j = options.develop) === null || _j === void 0 ? void 0 : _j.host) !== null && _k !== void 0 ? _k : config.develop.host,
                allowedHosts: (_m = (_l = options.develop) === null || _l === void 0 ? void 0 : _l.allowedHosts) !== null && _m !== void 0 ? _m : config.develop.allowedHosts,
                webSocketURL: (_p = (_o = options.develop) === null || _o === void 0 ? void 0 : _o.webSocketURL) !== null && _p !== void 0 ? _p : config.develop.webSocketURL
            }
        };
    }
    return config;
